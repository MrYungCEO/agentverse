...
const TemplateList = () => {
  ...
  console.log("Rendering TemplateList. Filtered templates:", filteredTemplates);
      ...
      <div className="flex flex-col sm:flex-row gap-4 p-4 bg-card/50 rounded-lg shadow-md border border-border">
        ...
        <Select value={typeFilter} onValueChange={(value: 'all' | 'n8n' | 'make.com' | 'collection') => setTypeFilter(value)}>
          ...
          <SelectContent className="futuristic-select-content">
            ...
            <SelectItem key="n8n" value="n8n">n8n</SelectItem>
            <SelectItem key="make.com" value="make.com">Make.com</SelectItem>
